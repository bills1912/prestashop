...
class Whatsapp extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->version = '1.0.0';
        $this->author = 'Bill Van Ricardo Zalukhu';
        ...
        $this->displayName = $this->l('WhatsApp Direct Chat');
        $this->description = $this->l('This module will help the customer to contact the admin about the shop directly using WhatsApp platform.');

...
class Recaptcha extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('reCAPTCHA Module');
        $this->description = $this->l('PrestaShop captcha module for contact form, login form and registration form.');
    ...
    public function hookDisplayHeader()
    {
        if (Configuration::get('ETS_RCF_POSITION')) {
            ...
            if (
                $pos && ($controller === 'authentication' && ($create_account != 1 && in_array('login', $pos) || $create_account == 1 && in_array('register', $pos))) ||
